    ...
    >
      ...
      <div className="flex-1" />
        ...
        <div className="pointer-events-auto flex items-center gap-0.5 flex-shrink-0 px-1 py-0.5 rounded-md bg-slate-950/55 backdrop-blur-sm ring-1 ring-white/[0.06] shadow-[0_2px_8px_rgba(0,0,0,0.35)]">
          ...
          {/* Minimize to the bottom tray — parks this stream small + out
              of the way while it keeps playing (e.g. during an ad break). */}
          {onMinimize && (
            <OSDButton onClick={onMinimize} title="Minimize to tray — keeps playing" color="slate">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-3.5 h-3.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v9m0 0l-3.5-3.5M12 13l3.5-3.5M5 19h14" />
              </svg>
            </OSDButton>
          )}
